...
class CompaniesListViewModel @Inject constructor(
    ...
    private fun getCompaniesList() = viewModelScope.launch {
        ...
        val testListCompanies = listOf(
            Company("Компания 1", 1, "", 4.24f, 12, "Инфорация о компании", "от 2000р",reviewList),
            Company("Компания 2", 2, "", 3.54f, 2, "Инфорация о компании", "от 5000р",reviewList),
            Company("Компания 3", 3, "", 2.70f, 16, "Инфорация о компании", "от 1000р", null),
            Company("Компания 4", 4, "", 4.54f, 121, "Инфорация о компании", "от 2500р", null),
        )
